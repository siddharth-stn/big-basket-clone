    ...
    <header className='sticky top-0 grid md:grid-cols-[1fr_minmax(0,1135px)_1fr] py-3 text-[13.5px] shadow-xl border-t-4 border-green-700'>
      ...
      <div className='header-outer-mobile md:hidden px-2'>
        <div className="rows flex flex-col gap-4">
          <div className='row-one flex items-center justify-between'>
            ...
            <div className="btn-group flex items-center gap-3">
              ...
              <div onClick={() => { setDrawerOpen(true) }} className="show-drawer-btn cursor-pointer text-[#5d9400]">
        ...
        <div className={`drawer h-screen bg-white text-[14px] text-white fixed top-0 left-0 w-full z-50 py-5 px-4 ${drawerOpen ? "flex" : "hidden"} justify-between`}>
          ...
          <div onClick={() => { setDrawerOpen(false) }} className="exit-drawer-btn text-[#5d9400] cursor-pointer mt-1">
            <RxCross1 size={25} />
          </div>
        </div>
      </div>
