...
export default function Header() {
  return (
    <>
      <header className='sticky top-0 grid grid-cols-[1fr_minmax(0,1135px)_1fr] py-3 text-[13.5px] shadow-xl border-t-4 border-green-700'>
        ...
        <div className='header-outer md:col-start-2 md:px-6 lg:px-10 xl:px-0 flex flex-col gap-6'>
          <div className='row-one flex'>
            <div className='logo w-23'>
              <img src={logoImage} alt="logo" />
            </div>
          ...
          <div className='drawer-content flex items-center justify-between'>
            ...
            <div className='smart-basket-badge'>
              <div>
                <img src="https://www.bigbasket.com/media/uploads/banner_images/Smart_basket-250124-1.png" alt="badge" />
              </div>
            </div>
